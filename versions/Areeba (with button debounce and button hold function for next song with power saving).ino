...
🎉 Result
    ...
    The code has been optimized to include automatic power-saving sleep mode after 30 seconds of inactivity, and activity resets the timer after each button press or note played
*/
